...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="bg-gradient-to-b from-white to-violet-400 px-10 dark:bg-gradient-to-b dark:from-gray-900 dark:to-violet-950 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="pt-10 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl text-gray-800 dark:text-white">{"< "}MT{" >"}</h1>
          ...
          <div className="flex h-screen flex-col text-center">
            <div className="m-auto">
              ...
              <h2 className="text-5xl text-black dark:text-white font-medium md:text-9xl">
