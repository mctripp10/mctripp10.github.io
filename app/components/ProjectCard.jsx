...
const ProjectCard = ({ title, description, imgUrl, srcUrl, tags }) => {
    return (
        ...
        <div className="w-[475px] rounded-3xl bg-gray-900 transition-all duration-300 hover:border-to hover:bg-gradient-to-br hover:from-violet-950 hover:via-violet-950 via-65% hover:to-pink-500 hover:scale-105 bg-size-200 bg-pos-0 hover:bg-pos-100
