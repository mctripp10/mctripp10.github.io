      ...
      <main className="bg-gradient-to-b from-white to-violet-700 px-10 dark:bg-gradient-to-b dark:from-gray-900 dark:to-violet-950 md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <div className="flex flex-col text-center">
            <div className="mt-52 mb-20 mx-80 rounded-3xl bg-gray-900">
              <div className="mx-16 my-12">
              <h1 className="text-3xl md:text-6xl font-bold bg-gradient-to-br from-pink-500 to-violet-600 text-transparent bg-clip-text">
                About Me
              </h1>
              <p className="text-2xl font-light text-left mt-8">
                ...
                I graduated from Westminster College in May 2023 with a BS in Computer Science and Mathematics, allowing me to transition into my current role in data. <br /><br />
